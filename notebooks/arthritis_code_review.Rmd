...
```{r}
pairwise.wilcox.test(mapping_file$Age, as.factor(mapping_file$Diagnosis))
pairwise.wilcox.test(mapping_file$BMI, as.factor(mapping_file$Diagnosis))
```
...
d.bray <- vegdist(t(taxatable.genus))
